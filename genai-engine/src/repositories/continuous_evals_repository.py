...
class ContinuousEvalsRepository:
    ...
    def validate_transform_variable_mapping(
        ...
        mapped_transform_vars = {mapping.transform_variable for mapping in transform_variable_mapping}
        mapped_eval_vars = {mapping.eval_variable for mapping in transform_variable_mapping}
    ...
    def create_continuous_eval(
        ...
        transform_variable_mapping_dicts = [
            mapping.model_dump() for mapping in continuous_eval_request.transform_variable_mapping
        ]
    ...
    def update_continuous_eval(
        ...
        if update_continuous_eval.transform_variable_mapping:
            ...
            db_continuous_eval.transform_variable_mapping = [
                mapping.model_dump() for mapping in update_continuous_eval.transform_variable_mapping
            ]
            has_changes = True
