...
Handles metrics computation and storage for LLM spans, including:
- Metrics computation using the metrics engine
- Retrieval of existing metric results
- Storage of new metric results
- Span-to-metric request conversion
"""
...
class MetricsIntegrationService:
    """Service responsible for computing and managing metrics for spans."""
