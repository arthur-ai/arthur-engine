...
Handles the conversion of flat span lists into nested trace structures, including:
- Grouping spans by trace ID
- Building parent-child relationships
- Creating nested span hierarchies
- Sorting spans within traces
"""
...
class TreeBuildingService:
    """Service responsible for building trace trees from flat span lists."""
