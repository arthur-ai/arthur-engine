...
class TraceRetentionService(BaseQueueService[TraceRetentionJob]):
    """
    Background service that periodically deletes trace data (spans, trace_metadata,
    and related rows) older than the configured retention period (default 90 days).
    """
