...
Handles the conversion of protobuf trace data to database format, including:
- Protobuf parsing and validation
- Span extraction and processing
- Data normalization and cleanup
- Task ID validation and resource attribute processing
"""
...
class TraceIngestionService:
    """Service responsible for processing and storing trace data from protobuf format."""
    ...
    def process_trace_data(self, trace_data: bytes) -> Tuple[int, int, int, list[str]]:
        ...
        Returns:
            Tuple of (total_spans, accepted_spans, rejected_spans, rejected_reasons)
        """
        try:
