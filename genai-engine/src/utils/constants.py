...
GENAI_ENGINE_FAIL_FAST_WHEN_WARMING_ENV_VAR = "GENAI_ENGINE_FAIL_FAST_WHEN_WARMING"
GENAI_ENGINE_MODEL_WARMUP_RETRY_AFTER_SECONDS_ENV_VAR = (
    "GENAI_ENGINE_MODEL_WARMUP_RETRY_AFTER_SECONDS"
)
