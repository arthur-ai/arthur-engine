...
if relevance_models_enabled():
    MODEL_NAMES.append("RELEVANCE_MODEL")
    MODEL_NAMES.append("RELEVANCE_TOKENIZER")
    MODEL_NAMES.append("BERT_SCORER")
    MODEL_NAMES.append("RELEVANCE_RERANKER")
if USE_PII_MODEL_V2:
    MODEL_NAMES.append("PII_GLINER_MODEL")
    MODEL_NAMES.append("PII_GLINER_TOKENIZER")
    MODEL_NAMES.append("PII_PRESIDIO_ANALYZER")
