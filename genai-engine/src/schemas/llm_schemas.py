...
class LLMResponseSchema(BaseModel):
    ...
    # TODO: Question to Tal. I needed to rename a field here cause schema is reserved keyword on BaseModel.
    # Did we want to override the schema field on BaseModel?
