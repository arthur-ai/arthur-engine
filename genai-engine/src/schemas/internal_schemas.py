...
class DatasetVersion(BaseModel):
    ...
    def _from_request_model(
        ...
        unchanged_rows = [
            row
            for row in latest_version.version_rows
            if row.id not in new_version.rows_to_delete
        ]
        updated_rows = [
            DatasetVersionRow(
                id=updated_row.id,
    ...
    def _from_database_model(
        ...
        return DatasetVersion(
            ...
            rows=[
                ...
                for row in db_dataset_version.version_rows
            ],
            page=pagination_params.page,
            page_size=pagination_params.page_size,
            total_pages=pagination_params.calculate_total_pages(total_count),
