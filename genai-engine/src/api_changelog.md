...
- **CHANGE** for **URL**: /api/v2/tasks/search  added the new optional `query` request parameter `start_time`
- **CHANGE** for **URL**: /api/v2/tasks/search  added the new optional `query` request parameter `end_time`
