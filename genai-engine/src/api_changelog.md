...
# 06/11/2026
- **CHANGE** for **URL**: /api/v2/tasks/{task_id}/validate_prompt  added the new optional 'query' request parameter 'parent_span_id'
- **CHANGE** for **URL**: /api/v2/tasks/{task_id}/validate_prompt  added the new optional 'query' request parameter 'trace_id'
- **CHANGE** for **URL**: /api/v2/tasks/{task_id}/validate_response/{inference_id}  added the new optional 'query' request parameter 'parent_span_id'
- **CHANGE** for **URL**: /api/v2/tasks/{task_id}/validate_response/{inference_id}  added the new optional 'query' request parameter 'trace_id'
