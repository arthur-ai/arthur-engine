      ...
      <div className="max-w-md mx-auto text-center">
        <div className="bg-white rounded-lg shadow-lg p-8">
          <div className="mb-6">
            ...
            <h2 className="text-lg font-medium text-gray-700 mb-4">{featureName}</h2>
            {description && <p className="text-gray-600 mb-6">{description}</p>}
            <p className="text-sm text-gray-500">This feature is currently under development and will be available soon.</p>
          </div>
