  ...
  return (
    <>
      ...
      <Dialog
        ...
        aria-labelledby="delete-rag-notebook-dialog-title"
        aria-describedby="delete-rag-notebook-dialog-description"
      >
        <DialogTitle id="delete-rag-notebook-dialog-title">Delete RAG Notebook?</DialogTitle>
        <DialogContent>
          <DialogContentText id="delete-rag-notebook-dialog-description">
