        ...
        <Stack direction="row" justifyContent="space-between" alignItems="center">
          <Stack alignItems="flex-start">
            ...
            <Stack direction="row" gap={2}>
              <Typography variant="body2" color="text.secondary">
                <span className="font-bold">Created:</span> {formatDateInTimezone(agentExperiment.created_at, timezone)}
              </Typography>
              <Typography variant="body2" color="text.secondary">
                <span className="font-bold">Finished:</span> {formatDateInTimezone(agentExperiment.finished_at, timezone)}
              </Typography>
