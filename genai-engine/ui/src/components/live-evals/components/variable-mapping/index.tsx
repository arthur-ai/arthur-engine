...
import type { ContinuousEvalTransformVariableMappingRequest, ContinuousEvalVariableMappingResponse } from "@/lib/api-client/api-client";

interface VariableMappingSectionProps extends Pick<
  ContinuousEvalVariableMappingResponse,
  "eval_variables" | "transform_variables" | "matching_variables"
> {
  mappings: ContinuousEvalTransformVariableMappingRequest[];
  onChange: (mappings: ContinuousEvalTransformVariableMappingRequest[]) => void;
  disabled?: boolean;
  isLoading?: boolean;
}

export const VariableMappingSection: React.FC<VariableMappingSectionProps> = ({
  eval_variables,
  transform_variables,
  matching_variables,
  mappings,
