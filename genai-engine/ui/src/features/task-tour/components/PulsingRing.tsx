    ...
    <Box
      ...
      sx={{
        ...
        "&::after": {
          ...
          willChange: "inset, border-radius, opacity",
          animation: "taskTourPulse 1.6s ease-out infinite",
        },
        "@keyframes taskTourPulse": {
          "0%": { inset: 0, borderRadius: "inherit", opacity: 0.85 },
          "70%": { inset: "var(--task-tour-pulse-inset)", borderRadius: "var(--task-tour-pulse-radius)", opacity: 0 },
          "100%": { inset: "var(--task-tour-pulse-inset)", borderRadius: "var(--task-tour-pulse-radius)", opacity: 0 },
        },
