...
export const TASK_TOUR_TARGET_LOST_HINTS: Partial<Record<string, string>> = {
  ...
  "prompts.add-prompt-in-playground": "Use Add Prompt in the playground to create a side-by-side variant.",
  "prompts.review-playground-prompt": "Add a prompt first — the highlight moves to the newest prompt card once it appears.",
