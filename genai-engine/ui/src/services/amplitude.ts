...
export const EVENT_NAMES = {
  ...
  DATASET_CREATE_OPENED: "dataset/create_opened",
  DATASET_EDIT_OPENED: "dataset/edit_opened",
  DATASET_DELETE_CONFIRMED: "dataset/delete_confirmed",
  DATASET_UPDATED: "dataset/updated",
  DATASET_DELETED: "dataset/deleted",
  DATASET_DETAIL_OPENED: "dataset/detail_opened",
  DATASET_SAVE_VERSION: "dataset/save_version",
  DATASET_ROW_ADDED: "dataset/row_added",
  DATASET_ROW_UPDATED: "dataset/row_updated",
  DATASET_ROW_DELETED: "dataset/row_deleted",
  DATASET_COLUMNS_CONFIG_OPENED: "dataset/columns_config_opened",
  DATASET_COLUMNS_SAVED: "dataset/columns_saved",
  DATASET_COLUMN_ADDED: "dataset/column_added",
  DATASET_COLUMN_RENAMED: "dataset/column_renamed",
  DATASET_COLUMN_DELETED: "dataset/column_deleted",
  DATASET_FILL_COLUMN_OPENED: "dataset/fill_column_opened",
  DATASET_FILL_COLUMN_APPLIED: "dataset/fill_column_applied",
  DATASET_IMPORT_OPENED: "dataset/import_opened",
  DATASET_IMPORT_PREVIEWED: "dataset/import_previewed",
  DATASET_IMPORT_COMPLETED: "dataset/import_completed",
  DATASET_IMPORT_FAILED: "dataset/import_failed",
  DATASET_EXPORT_CLICKED: "dataset/export_clicked",
  DATASET_EXPERIMENTS_VIEWED: "dataset/experiments_viewed",
  DATASET_VERSION_DRAWER_OPENED: "dataset/version_drawer_opened",
  DATASET_VERSION_SELECTED: "dataset/version_selected",
  DATASET_VERSION_SWITCH_CONFIRMED: "dataset/version_switch_confirmed",
  DATASET_SEARCH_CHANGED: "dataset/search_changed",
  DATASET_SORT_CHANGED: "dataset/sort_changed",
  DATASET_PAGINATION_CHANGED: "dataset/pagination_changed",
  DATASET_CELL_MODAL_OPENED: "dataset/cell_modal_opened",
  DATASET_CELL_COPIED: "dataset/cell_copied",
