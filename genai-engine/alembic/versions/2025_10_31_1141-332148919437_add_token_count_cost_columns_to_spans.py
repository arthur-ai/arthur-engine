"""add_token_count_cost_columns_to_spans

Revision ID: 332148919437
Revises: 2264832c91c0
Create Date: 2025-10-31 11:41:57.075909
...
def upgrade() -> None:
    ...
    # Backfill spans table with token counts and costs from raw_data
    _backfill_spans_token_data()

    # Backfill trace_metadata by aggregating from spans
