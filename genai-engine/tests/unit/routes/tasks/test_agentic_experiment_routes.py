...
def test_agentic_experiment_routes_happy_path(
    ...
    assert len(our_experiment.http_template.headers) == 2
    ...
    # Should have exactly 2 variables: dataset column and generated UUID
    assert len(test_case.template_input_variables) == 2, (
        f"Expected 2 variables (dataset column and generated UUID), "
