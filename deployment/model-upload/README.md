...
- **Repo + CI artifact** — the committed `aibom.cdx.json` (diffable model inventory) is
  regenerated by the model-upload build workflows and also uploaded as a workflow artifact.
