...
class InferencesApi:
    ...
    def query_inferences_api_v2_inferences_query_get(
        self,
        task_ids: Annotated[
            Optional[List[Optional[StrictStr]]], Field(description="Task ID to filter on.")
        ] = None,
        task_name: Annotated[
            Optional[StrictStr], Field(description="Task name to filter on.")
        ] = None,
        conversation_id: Annotated[
            Optional[StrictStr], Field(description="Conversation ID to filter on.")
        ] = None,
        inference_id: Annotated[
            Optional[StrictStr], Field(description="Inference ID to filter on.")
        ] = None,
        user_id: Annotated[Optional[StrictStr], Field(description="User ID to filter on.")] = None,
        start_time: Annotated[
            Optional[datetime], Field(description="Inclusive start date in ISO8601 string format.")
        ] = None,
        end_time: Annotated[
            Optional[datetime], Field(description="Exclusive end date in ISO8601 string format.")
        ] = None,
        rule_types: Annotated[
            Optional[List[RuleType]],
            Field(
        ...
        rule_statuses: Annotated[
            Optional[List[RuleResultEnum]],
            Field(
