...
class HttpHeader(BaseModel):
    ...
    name: StrictStr = Field(description="Header name (supports {{variable}} placeholders)")
    value: StrictStr = Field(description="Header value (supports {{variable}} placeholders)")
