...
class TraceListResponse(BaseModel):
    ...
    """ # noqa: E501
    count: StrictInt = Field(description="Total number of traces matching filters")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "traces": [TraceMetadataResponse.from_dict(_item) for _item in obj["traces"]] if obj.get("traces") is not None else None
        })
        return _obj
