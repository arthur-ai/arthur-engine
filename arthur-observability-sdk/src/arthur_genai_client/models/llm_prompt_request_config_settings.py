        ...
        _obj = cls.model_validate(
            {
                ...
                "logit_bias": (
                    [LogitBiasItem.from_dict(_item) for _item in obj["logit_bias"]]
                    if obj.get("logit_bias") is not None
                    else None
                ),
                "max_completion_tokens": obj.get("max_completion_tokens"),
                "reasoning_effort": obj.get("reasoning_effort"),
                "thinking": (
                    AnthropicThinkingParam.from_dict(obj["thinking"])
                    if obj.get("thinking") is not None
                    else None
                ),
                "response_format": (
                    LLMResponseFormatInput.from_dict(obj["response_format"])
                    if obj.get("response_format") is not None
                    else None
                ),
                "tool_choice": (
                    ToolChoice.from_dict(obj["tool_choice"])
                    if obj.get("tool_choice") is not None
                    else None
                ),
                "stream_options": (
                    StreamOptions.from_dict(obj["stream_options"])
