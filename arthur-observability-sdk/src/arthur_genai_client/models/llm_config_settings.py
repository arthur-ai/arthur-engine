...
class LLMConfigSettings(BaseModel):
    ...
    response_format: Optional[LLMResponseFormatOutput] = None
    stream_options: Optional[StreamOptions] = None
    __properties: ClassVar[List[str]] = ["timeout", "temperature", "top_p", "max_tokens", "stop", "presence_penalty", "frequency_penalty", "seed", "logprobs", "top_logprobs", "logit_bias", "max_completion_tokens", "reasoning_effort", "thinking", "tool_choice", "response_format", "stream_options"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "response_format": LLMResponseFormatOutput.from_dict(obj["response_format"]) if obj.get("response_format") is not None else None,
