...
from arthur_genai_client.models.weaviate_keyword_search_settings_request import (
...
class RagKeywordSearchSettingRequest(BaseModel):
    ...
    settings: WeaviateKeywordSearchSettingsRequest = Field(
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "settings": (
                    WeaviateKeywordSearchSettingsRequest.from_dict(obj["settings"])
