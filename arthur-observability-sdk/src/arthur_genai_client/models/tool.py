...
class Tool(BaseModel):
    ...
    arguments: Optional[List[ToolArgument]] = Field(
        default=None, description="List of arguments for this tool."
    )
        ...
        _obj = cls.model_validate(
            {
                "name": obj.get("name"),
                "arguments": (
                    [ToolArgument.from_dict(_item) for _item in obj["arguments"]]
