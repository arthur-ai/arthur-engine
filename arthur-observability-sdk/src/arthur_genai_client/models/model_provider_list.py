...
class ModelProviderList(BaseModel):
    ...
    ModelProviderList
    """ # noqa: E501
    providers: List[ModelProviderResponse] = Field(description="List of model providers")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "providers": [ModelProviderResponse.from_dict(_item) for _item in obj["providers"]] if obj.get("providers") is not None else None
        })
        return _obj
