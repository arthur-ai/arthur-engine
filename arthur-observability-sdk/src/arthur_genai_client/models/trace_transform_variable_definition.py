...
class TraceTransformVariableDefinition(BaseModel):
    ...
    """ # noqa: E501
    variable_name: StrictStr = Field(description="Name of the variable to extract.")
    span_name: StrictStr = Field(description="Name of the span to extract data from.")
    attribute_path: StrictStr = Field(description="Dot-notation path to the attribute within the span (e.g., 'attributes.input.value.sqlQuery').")
    fallback: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["variable_name", "span_name", "attribute_path", "fallback"]
