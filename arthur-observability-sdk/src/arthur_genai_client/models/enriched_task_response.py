...
class EnrichedTaskResponse(BaseModel):
    ...
    is_autocreated: Optional[StrictBool] = Field(
        default=False, description="Whether this task was auto-created (vs manually created)"
    )
    ...
    rules: Optional[List[RuleResponse]] = Field(
        default=None, description="Rules associated with this task"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "is_autocreated": (
                    obj.get("is_autocreated") if obj.get("is_autocreated") is not None else False
                ),
                "creation_source": (
                    AgentCreationSource.from_dict(obj["creation_source"])
                    if obj.get("creation_source") is not None
                    else None
                ),
                "last_fetched": obj.get("last_fetched"),
                "tools": (
                    [Tool.from_dict(_item) for _item in obj["tools"]]
                    if obj.get("tools") is not None
                    else None
                ),
                "sub_agents": (
                    [SubAgent.from_dict(_item) for _item in obj["sub_agents"]]
                    if obj.get("sub_agents") is not None
                    else None
                ),
                "models": (
                    [LLMModel.from_dict(_item) for _item in obj["models"]]
                    if obj.get("models") is not None
                    else None
                ),
                "data_sources": (
                    [DataSource.from_dict(_item) for _item in obj["data_sources"]]
