...
class SpanListResponse(BaseModel):
    ...
    """ # noqa: E501
    count: StrictInt = Field(description="Total number of spans matching filters")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "spans": [SpanMetadataResponse.from_dict(_item) for _item in obj["spans"]] if obj.get("spans") is not None else None
        })
        return _obj
