...
class RequestTimeParameterSource(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="Type of source: 'request_time_parameter'")
    __properties: ClassVar[List[str]] = ["type"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['request_time_parameter']):
            raise ValueError("must be one of enum values ('request_time_parameter')")
        return value
