...
class RegexSpanResponse(BaseModel):
    ...
    RegexSpanResponse
    """ # noqa: E501
    matching_text: StrictStr = Field(description="The subtext within the input string that matched the regex rule.")
    pattern: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["matching_text", "pattern"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "matching_text": obj.get("matching_text"),
