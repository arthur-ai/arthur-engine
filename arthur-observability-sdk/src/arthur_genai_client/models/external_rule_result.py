...
class ExternalRuleResult(BaseModel):
    ...
    latency_ms: StrictInt = Field(description="Duration in millisesconds of rule execution")
    details: Optional[Details] = None
    __properties: ClassVar[List[str]] = ["id", "name", "rule_type", "scope", "result", "latency_ms", "details"]
