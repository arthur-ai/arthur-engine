...
INCLUDEVECTOR_ANY_OF_SCHEMAS = ["List[str]", "bool", "str"]

class IncludeVector(BaseModel):
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        instance = IncludeVector.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in IncludeVector with anyOf schemas: List[str], bool, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into IncludeVector with anyOf schemas: List[str], bool, str. Details: " + ", ".join(error_messages))
        else:
            return instance
