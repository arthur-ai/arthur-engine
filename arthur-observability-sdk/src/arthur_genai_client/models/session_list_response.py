...
class SessionListResponse(BaseModel):
    ...
    """ # noqa: E501
    count: StrictInt = Field(description="Total number of sessions matching filters")
    sessions: List[SessionMetadataResponse] = Field(description="List of session metadata")
    __properties: ClassVar[List[str]] = ["count", "sessions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "sessions": [SessionMetadataResponse.from_dict(_item) for _item in obj["sessions"]] if obj.get("sessions") is not None else None
        })
        return _obj
