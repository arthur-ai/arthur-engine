...
from arthur_genai_client.models.weaviate_vector_similarity_text_search_settings_request import (
...
class RagVectorSimilarityTextSearchSettingRequest(BaseModel):
    ...
    settings: WeaviateVectorSimilarityTextSearchSettingsRequest = Field(
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "settings": (
                    WeaviateVectorSimilarityTextSearchSettingsRequest.from_dict(obj["settings"])
