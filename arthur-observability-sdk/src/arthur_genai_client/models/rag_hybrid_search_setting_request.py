...
from arthur_genai_client.models.weaviate_hybrid_search_settings_request import (
...
class RagHybridSearchSettingRequest(BaseModel):
    ...
    settings: WeaviateHybridSearchSettingsRequest = Field(
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "settings": (
                    WeaviateHybridSearchSettingsRequest.from_dict(obj["settings"])
